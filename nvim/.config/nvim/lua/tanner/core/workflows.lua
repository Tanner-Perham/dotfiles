...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd ~/Obsidian/GrumblyGhost<cr>")
--
...
vim.keymap.set("n", "<leader>os", ':Telescope find_files search_dirs={"~/Obsidian/GrumblyGhost"}<cr>')
vim.keymap.set("n", "<leader>oz", ':Telescope live_grep search_dirs={"~/Obsidian/GrumblyGhost"}<cr>')
--
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /~Obsidian/GrumblyGhost/zettelkasten<cr>:bd<cr>")
